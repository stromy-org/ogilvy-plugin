...
description: "Construir el panorama completo de un tema de politica publica dominicana cruzando todas las fuentes oficiales. Usar para un brief de contexto amplio, no para un dato puntual."
---
<!--
  GENERATED FILE -- DO NOT EDIT.
  Owner:       scripts/sync-codex-plugin-skills.py
  Source:      skills/do-policy-landscape/SKILL.md
...
# do-policy-landscape — panorama de un tema (MCP-hosted skill)
...
2. Discover reference files (and any other skill assets), then read on demand:
   ...
   → call `fs_read` with `path="skills/do-policy-landscape/references/<file>"`.
